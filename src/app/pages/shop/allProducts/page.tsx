...
async function getData() {
  const res = await fetch('https://u4m48ujb.api.sanity.io/v2023-05-28/data/query/production?query=*%5B_type%20%3D%3D%20%22product%22%5D%7B%22firstImage%22%3A%20images%5B0%5D.asset._ref%2C%20title%2C%20subTitle%2C%20price%2C%20_id%7D%0A',
    {next: {revalidate: 600}});
